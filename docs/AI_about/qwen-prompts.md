...
> 掌握 Qwen3.6-35B-A3B、Qwen3-235B 的提示词技巧，充分发挥阿里通义千问 MoE 系列模型的强大能力

![Qwen Logo](https://img.shields.io/badge/Qwen3.6--35B--A3B%2FQwen3-blue)
![Status](https://img.shields.io/badge/状态-已更新至Qwen3.6系列-green)
...
| ----------------------- | ---------- | ---- | ------ | -------- | ----------- | ---------------------- | ---------------------------- |
| **Qwen3.6-35B-A3B**     | 2026年4月  | MoE  | 350B   | 30B      | 128K tokens | 轻量高效、编程视觉强   | 本地部署、智能体编程         |
| **Qwen3-235B**          | 2026年     | MoE  | 235B   | 22B      | 128K tokens | 开源性能天花板         | 企业自部署、高精度场景       |
| **Qwen3.5-397B**        | 2026年     | MoE  | 397B   | —        | 128K tokens | 最高质量               | 高质量推理、复杂任务         |
| **Qwen-Max**            | 2024年     | Dense| —      | —        | 32K tokens  | 旧版旗舰（API）       | 旧兼容场景                   |
| **Qwen-Plus/Turbo**     | 2024年     | Dense| —      | —        | 128K tokens | 旧版均衡（API）       | 旧兼容场景                   |

### 1.2 核心优势

✅ **开源生态标杆**：Apache 2.0 协议，从 8B 到 397B 全系列覆盖  
✅ **MoE 架构效率高**：Qwen3.6-35B-A3B 仅 30B 激活参数，21GB 量化即可本地运行  
✅ **编程能力突出**：Qwen3.6 编程能力与 DeepSeek V4-Pro 比肩  
✅ **多模态支持**：Qwen-VL 系列支持图像理解  
✅ **端云一体**：8B~14B 小模型可在边缘设备运行

### 1.3 限制与注意事项

⚠️ **英文能力**：虽然支持英文，但能力不如中文  
⚠️ **上下文限制**：最高 128K tokens，暂无百万级上下文版本  
⚠️ **API速率限制**：有每分钟/每天的调用次数限制  
⚠️ **旧版已停止主要更新**：建议新项目直接使用 Qwen3.6 MoE 系列
...
- **2026-05-31**：更新至Qwen3.6 MoE系列（Qwen3.6-35B-A3B / Qwen3-235B）
- **2026-05-18**：初始版本发布，包含Qwen-Max/Plus/Turbo提示词
