...
| 层 | 技术 | 说明 |
|----|------|------|
| 前端 | Vue 3 + Element Plus + Vite | Composition API，中文组件库 |
| 后端 | Express 5 + Prisma ORM | RESTful API，JWT 认证 |
| 数据库 | SQLite / MySQL | 开发开箱即用，生产无缝切换 |
| 进程管理 | PM2 | 守护进程 + 日志管理 |
...
### 入门必读
- [KEC 说明文档](/kec/kec-readme) — 完整的 README，含 API 文档和数据库设计
...
### 质量保障
- [代码审计报告](/kec/code-audit-report) — V1 审计（28 个问题，89% 已修复）
- [代码审计报告 V2](/kec/code-audit-report-v2) — V2 审计（50+ 问题，含安全加固建议）
